...
<body>
   ...
   <pre>
      ...
      ** test 속성 값 작성 시 주의 사항 **
      ...
      2) 속성 값은 무조건 true/false가 최종 결과로 나와야 한다!

      3) 속성 값을 작성하는 "" 제일 앞/뒤에는 
         띄어쓰기가 있으면 안된다!!
   ...
   <hr>
                     <%-- 선택       언제    그렇지않다면--%>
   <h1>1. 연속된 조건문 (c:choose / c:when / c:otherwise) </h1>
   <%-- if ~ else if ~ else --%>
   <pre>
   ...
   <h4>테스트 방법</h4>
   <pre>
      주소창에 값을 직접 입력한 후 \${param.key}를 이용해 값 얻어오기
