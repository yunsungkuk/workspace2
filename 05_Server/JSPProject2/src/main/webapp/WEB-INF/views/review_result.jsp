...
<body>
   ...
   <ul>
      <li>paramValues.bobby : ${paramValues.hobby}</li>
      <li>paramValues.bobby[0] : ${paramValues.hobby[0]}</li>
      <li>paramValues.bobby[1] : ${paramValues.hobby[1]}</li>
      <li>paramValues.bobby[2] : ${paramValues.hobby[2]}</li>
      <li>paramValues.bobby[3] : ${paramValues.hobby[3]}</li>
   </ul>
