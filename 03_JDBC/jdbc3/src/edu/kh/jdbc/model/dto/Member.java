...
public class Member {
	...
	public Member(int memberNo, String memberEmail, String memberPw, String memberNickname, String memberTel,
			String memberAddress, String enrollDate, String memberDelFl, String updatePw) {
		super();
	...
	public void setMemberTal(String memberTel) {
		this.memberTel = memberTel;
	}
	...
	public String toString() {
		return "Member [memberNo=" + memberNo + ", memberEmail=" + memberEmail + ", memberPw=" + memberPw
				...
				+ ", enrollDate=" + enrollDate + ", memberDelFl=" + memberDelFl + ", updatePw=" + updatePw + "]";
	}
