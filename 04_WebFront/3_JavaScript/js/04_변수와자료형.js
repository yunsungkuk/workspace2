...
// console.log(con3); let3 is not defined
...
function typeTest(){
   ...
   const phone = '01055552221'; // string
   ...
   /* object */
   const arr = [10, 30, 50, 40, 20]; // object
   print(arr);
   ...
   /* 요즘(2023년)에 함수 선언, 정의하는 트랜드 */

   // function(){} : 익명 함수(함수명 없음)

   // 변수명 == 함수명
   const sunFn = function(n1, n2){ return n1 + n2;}

   // 함수 호출
   console.log(sunFn(10,40));
   print(sunFn);
