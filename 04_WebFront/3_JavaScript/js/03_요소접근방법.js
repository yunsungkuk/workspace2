...
function idTest(){
   ...
   // 아이디가 "div1"인 요소(객체)를 얻어와 div1 변수에 저장
   const div1 = document.getElementById("div1");

   // Java에서 배열 리터럴 표기법 : {}
   // JS에서 배열 리터럴 표기법 : []
   const colorArray = ['red', "yellow", 'green', "#455ba8", 'while', 'pink'];
...
function nameTest(){
   ...
   for(let i=0 ; i<hobbyArray.length ; i++){
      ...
      // 요소.checked = false -> 해당 요소 체크해제
      if(hobbyArray[i].checked){ // 체크가 되어 있다면
         count++;
