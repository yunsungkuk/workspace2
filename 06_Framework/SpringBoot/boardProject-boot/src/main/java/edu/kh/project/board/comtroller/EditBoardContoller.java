package edu.kh.project.board.comtroller;
...
public class EditBoardContoller {
	 ...
	 * @param loginMember : 세션에 저장된 로그인 회원의 정보(로그인 X면 null)
...
//			@RequestHeader("referer") String referer
	...
	//				file 타입 데이터만 추출해 저장하는 String 제공 객체
	// - 실제 파일
	// - 파일 이름
	// - 파일 크기
	...
	public String profile(
		@RequestParam("profileImge") MultipartFile profileImg ) {
