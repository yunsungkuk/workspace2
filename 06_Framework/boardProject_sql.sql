...
-- 계정 생성
CREATE USER spring_ysk IDENTIFIED BY spring1234;

-- 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO spring_ysk;

-- 객체 생성 공간 할당
ALTER USER spring_ysk DEFAULT TABLESPACE "A230724"
...
VALUES(SEQ_MEMBER_NO.NEXTVAL , 'member01@naver.com' , 'pass01' , '회원1',
	'01012341234' , '04540^^^서울시 중구 남대문로 120^^^2층' , NULL , 
...
UPDATE "MEMBER" SET 
MEMBER_PW = '$2a$10$SP8Com2POmVrvUVurhYMV.yq5K4TOgJC/Ici3saH38lCeHvMrqm66'
WHERE MEMBER_NO = 1;
...
SELECT MEMBER_NO , MEMBER_EMAIL , MEMBER_NICKNAME , MEMBER_TEL , 
		MEMBER_ADDRESS , AUTHORITY , MEMBER_DEL_FL ,
		TO_CHAR( ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"' ) AS ENROLL_DATE
FROM "MEMBER"
WHERE MEMBER_EMAIL = 
;
...
BEGIN
   FOR I IN 1..300 LOOP
      ...
      VALUES(SEQ_COMMENT_NO.NEXTVAL, 
            ...
            DEFAULT, DEFAULT,
            5, CEIL(DBMS_RANDOM.VALUE(0,1500)), NULL);
   END LOOP;
END;
...
/* 게시글 좋아요 샘플 데이터 */
INSERT INTO "BOARD_LIKE" VALUES(1, 1500); -- 2 
INSERT INTO "BOARD_LIKE" VALUES(2, 1499); -- 3
INSERT INTO "BOARD_LIKE" VALUES(3, 1498); -- 3
INSERT INTO "BOARD_LIKE" VALUES(4, 1497); -- 2
INSERT INTO "BOARD_LIKE" VALUES(5, 1496); -- 2
INSERT INTO "BOARD_LIKE" VALUES(6, 1495); -- 3
INSERT INTO "BOARD_LIKE" VALUES(18, 1494); -- 2

COMMIT;

SELECT * FROM BOARD_LIKE;

--ALTER TABLE "BOARD_LIKE" MODIFY BOARD_NO INVISIBLE;
--ALTER TABLE "BOARD_LIKE" MODIFY BOARD_NO VISIBLE;
...
-- 회원 프로필 이미지 추가
UPDATE "MEMBER" SET 
PROFILE_IMG = '/images/member/tangerine-sample.jpg'
WHERE MEMBER_NO = 1;
