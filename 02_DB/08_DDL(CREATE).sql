...
INSERT INTO MEMBER 
VALUES('MEM01', '123ABC', '홍길동', '930511-1214454', DEFAULT);
												-- TO_DATE ('2023-08-27')
												-- SYSDATE
												-- DEFAULT (= 기본값(SYSDATE))
...
-- 가입일 -> SYSDATE를 활용
INSERT INTO MEMBER 
VALUES('MEM02', 'QWER1234', '김영희', '980808-1987654', SYSDATE);
...
SELECT * FROM MEMBER;
-- CREATE할때 DEFAULT값으로 설정해서 DEFAULT값으로 등록됨
...
-- ORA-01400: NULL을 ("A230724_YSK"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(A230724_YSK.SYS_C0013068)에 위배됩니다
-- SYS_C0013068 : 제약 조건 이름 미설정 시 자동으로 지정되는 이름

-- ORA-00001: 무결성 제약 조건(A230724_YSK.USER_ID_U)에 위배됩니다
