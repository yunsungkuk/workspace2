...
-- 계정 생성
CREATE USER a230830_ysk IDENTIFIED BY "123456";
--> 생성 후 DB 접속 방법 추가
-- ORA-01045: 사용자 A230830_YSK는 CREATE SESSION 권한을 가지고있지 않음; 로그온이 거절되었습니다
--> 접속 권한 없음

/* 접속 권한 부여(GRANT) */
GRANT CREATE SESSION TO a230830_ysk;
...
--> 테이블 생성 권한 (CREATE TABLE) 없어 생성 불가
--> + TABLESPACE(테이블 생성 공간(용량))도 없어서 생성 불가

------- [관리자 계정] -------
-- 테이블 생성 권한, TABLESPACE 할당
GRANT CREATE TABLE TO a230830_ysk;

ALTER USER a230830_ysk DEFAULT TABLESPACE "A230724"
...
GRANT CONNECT, RESOURCE, CREATE VIEW TO a230830_ysk;
...
VALUES (79, '1233', '11112');
COMMIT;

-- 권한 회수
REVOKE SELECT, INSERT ON TB_MEMBER FROM A230830_BDH;

SELECT * FROM A230830_BDH.TB_MEMBER.TB_MEMBER;
