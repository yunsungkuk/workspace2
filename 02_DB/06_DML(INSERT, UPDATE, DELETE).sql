--- *** DML(Data Manipulation Language) : 데이터 조작 언어 (영어 언어 잘 알아두기)
...
-- SELECT , INSERT , UPDATE , DELETE 필수 외우기
...
-- 1)  INSERT INTO 테이블명 VALUES(데이터, 데이터, ...) ** 꼭 외워야하는 작성법 **
...
SELECT BONUS FROM EMPLOYEE2; -- 확인
...
SELECT * FROM EMP_M01; 
SELECT * FROM EMP_M02; -- EMP_M01과 겹치는 행 4행, 겹치지 않는 행 1행

UPDATE EMP_M02 SET SALARY = 0;

SELECT * FROM EMP_M02;

MERGE INTO EMP_M01 USING EMP_M02 ON(EMP_M01.EMP_ID = EMP_M02.EMP_ID) -- 사번을 기준으로 매칭
...
-- 조회 SELECT열을 DELETE로 변경하면 쉽게 삭제가능
