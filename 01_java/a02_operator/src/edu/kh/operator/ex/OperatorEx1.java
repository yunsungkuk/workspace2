...
public class OperatorEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(); //괄호안에 아무것도 안적혀있으면 줄바꿈(개행)
		
		// + 연산
		System.out.println(input1 + " + " + input2 + " = " + (input1 + input2));
		
		// - 연산
		int minusResul = input1 - input2;
		
		System.out.println(input1 + " - " + input2 + " = " + minusResul);
		...
		// -> doutble / int -> double / double
		//                              (자동 형변환)
		
		
		
		// % (나머지) 연산 -> 몫이 정수로 다 나눠진 후 나머지가 출력이 됨
		System.out.println();
		System.out.printf("%d %% %d = %d" , input1, input2, input1 % input2);
