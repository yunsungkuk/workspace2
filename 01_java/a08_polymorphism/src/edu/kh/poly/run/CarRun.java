...
import edu.kh.poly.medel.service.PolyService;
...
public class CarRun {
	public static void main(String[] args) {
		...
		// 선수 지식
		// 1. 컴퓨터의 값 처리 원칙
		// - 컴퓨터는 같은 자료형 끼리만 연산 가능, 연산 결과도 같은 자료형
		...
		// 부모 참조 변수 = 자식 객체 생성
		Car c2 = new Porsche(); // 에러가 발생안하는 이유?
		...
		for (int i = 0; i < 6; i++) { // ctrl + shift + f : 자동 정렬 (정확도가 높진 않음)
