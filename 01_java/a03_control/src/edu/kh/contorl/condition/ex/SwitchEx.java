...
public class SwitchEx {
	...
	/* switch문
	 *  - 식 하나로 많은 경우의 수를 처리 할때 사용하는 조건문
	...
	public void ex3() {
		...
		//* 값의 의미를 부여해서 조건식에 사용하는 방법을 이해해야 한다.
	...
	public void ex4() {
		...
		int result = 0; // 계산 결과 저장 변수 선언 및 초기화
		                // -> 초기화를 했기 때문에
		...
		case "/" : result = num1 / num2; break;
		case "%" : result = num1 % num2; break;
		default : flag = true; // 연산자를 잘못 입력 -> flag를 true
		}
		...
		if(!flag) { // 정상 입력 == flag가 false
			...
			System.out.printf("존재하지 않는 연산자 입니다.");
		}
