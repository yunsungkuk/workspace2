...
public class BasicRun {
	public static void main(String[] args) {
		...
		n1.pNo = "991221-1235545";
		n1.name = "홍홍일";
		n1.gender = '남';
		n1.address = "서울시 중구 남대문로 120 청계그레이츠 2층";
		n1.phone = "010-5646-4445";
		n1.age = 23;
		...
		//n1.job = "국정원 비밀요원";
		// The field Nation.job is not visivle : job 변수 안보여
		...
		System.out.printf("%s의 나이는 %d세 입니다." , n1.name , n1.age);
		System.out.printf("%s의 나이는 %d세 입니다." , n2.name , n2.age);
		System.out.printf("%s의 나이는 %d세 입니다." , n3.name , n3.age);
