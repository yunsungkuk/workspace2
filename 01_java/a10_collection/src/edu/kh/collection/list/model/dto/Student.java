...
// 자식 클래스 만들기
// private에 들어갈 기본 자료 넣기
// 기본생성자 생성 -> 컨트롤 쉬프트 엔터
// 매개변수 생성자 생성 -> 알트 쉬프트 s -> o
// gettor, settor 생성 -> 알트 쉬프트 s -> r
// 오버라이딩 생성 -> 알트 쉬프트 s -> s

// Comparable <Student> 인터페이스
// -> Student 객체 정렬 기준을 정하기 위한 기능
//    compareTo()을 제공하는 인터페이스
...
public class Student implements Comparable<Student> {
	...
	// A.equals(B) : 
	// A 객체와 B 객체가 가지고있는 필드의 값이 모두 같으면 true, 아니면 false
	// 
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof Student)) { // 비교 대상이 Student이 아니면
			return false;
		}
		// obj가 참조 변수를 Student로 다운 캐스팅
