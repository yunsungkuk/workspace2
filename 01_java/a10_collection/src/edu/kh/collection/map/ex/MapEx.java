...
public class MapEx {
	...
	public void ex1() {
		...
		System.out.println("K:V 몇쌍? : " + map.size() + "쌍");
		
		// 4. V map.remove(K k) : 
		//   map에서 Key가 일치하는 요소 (K:V 쌍)을 제거
		//   제거되는 V반환, 없으면 null 반환
		...
		// 6. boolean.map.isEmpty() : 비어있으면 True, 아님 false
	...
	public void ex3() {
		...
		Set<String> set = s1.keySet(); // Ket들의 집합
